...
class SelectedSalesItems extends StatefulWidget {
  const SelectedSalesItems(
      {super.key, required this.selectedAccountItems, required this.notifier});

  final List<String> selectedAccountItems;
  final SalesItemsNotifier notifier;

  @override
  State<SelectedSalesItems> createState() => _SelectedSalesItemsState();
}

class _SelectedSalesItemsState extends State<SelectedSalesItems> {
