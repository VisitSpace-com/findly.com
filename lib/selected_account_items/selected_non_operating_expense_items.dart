...
class SelectedNonOperatingExpenseItems extends StatefulWidget {
  const SelectedNonOperatingExpenseItems(
      {super.key, required this.selectedAccountItems, required this.notifier});

  final List<String> selectedAccountItems;
  final NonOperatingExpenseItemsNotifier notifier;

  @override
  State<SelectedNonOperatingExpenseItems> createState() =>
      _SelectedNonOperatingExpenseItemsState();
}

class _SelectedNonOperatingExpenseItemsState
    extends State<SelectedNonOperatingExpenseItems> {
