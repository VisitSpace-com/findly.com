...
class SelectedExtraordinaryLossItems extends StatefulWidget {
  const SelectedExtraordinaryLossItems(
      {super.key, required this.selectedAccountItems, required this.notifier});

  final List<String> selectedAccountItems;
  final ExtraordinaryLossItemsNotifier notifier;

  @override
  State<SelectedExtraordinaryLossItems> createState() =>
      _SelectedExtraordinaryLossItemsState();
}

class _SelectedExtraordinaryLossItemsState
    extends State<SelectedExtraordinaryLossItems> {
