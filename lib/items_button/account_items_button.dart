...
class AccountItemsButtonState extends ConsumerState<AccountItemsButton> {
  ...
  Widget build(BuildContext context) {
    final selectedItems =
        ref.watch(accountItemsProvider(PLItems.operatingCostItems));
    final notifier =
        ref.read(accountItemsProvider(PLItems.operatingCostItems).notifier);
    final List<MapEntry<String, String>> items =
        PLItems.values.expand((item) => item.accountItems.entries).toList();
