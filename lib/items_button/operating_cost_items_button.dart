...
class OperatingCostItemsButton extends ConsumerStatefulWidget {
  const OperatingCostItemsButton({super.key});

  @override
  ConsumerState<OperatingCostItemsButton> createState() =>
      OperatingCostItemsButtonState();
}

class OperatingCostItemsButtonState
    extends ConsumerState<OperatingCostItemsButton> {
  bool isHovered = false;

  @override
  Widget build(BuildContext context) {
    final selectedItems = ref.watch(operatingCostItemsProvider);
